# Understanding Federal and State Taxes - Day 2 Learning Lab
...
**Your Home State ({{STATE_NAME}}):**
- State income tax rate: {{STATE_INCOME_TAX_RATE}}%
- State sales tax: {{STATE_SALES_TAX}}%
- Average property tax rate: {{STATE_PROPERTY_TAX_COUNTY_RATE}}%

For each state you research, analyze the complete tax picture including income, sales, and property taxes. Compare how {{STATE_NAME}}'s tax structure differs from the other states you research.
